...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            # Removed unsupported options for python-oracledb
            # encoding, use_returning_into, threaded, init_command are not needed
        },
     }
    ...
    #     'ENGINE': 'django.db.backends.oracle',
    #     'NAME': 'PROD',  # Oracle SID or service name
    #     'USER': 'timesheet',  # Oracle username for client server
    #     'PASSWORD': 'KgJyrx3$1',  # Oracle password for client server
    #     'HOST': '185.197.251.203',  # Oracle host for client server
    #     'PORT': '1521',  # Default Oracle port
    #     'OPTIONS': {
    #         # Removed unsupported options for python-oracledb
    #         # encoding, use_returning_into, threaded, init_command are not needed
